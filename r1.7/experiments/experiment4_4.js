...
window.initExperiment = function() {
    const sketch = (p) => {
      ...
      const WIGGLE_STRENGTH    = 150;       // Maximum wiggle offset in pixels
      const WIGGLE_FREQ        = 0.015;    // Frequency of noise-based wiggle
      ...
      // Hover Configuration
      const HOVER_RADIUS       = 300;      // Radius in pixels to trigger wiggle
